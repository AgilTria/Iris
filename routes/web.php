...
Route::middleware('auth')->group(function () {
    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard.index');
        // route flowise:
        Route::post('/api/chat', [ChatController::class, 'sendQuestion']);
        Route::get('/chat', function () {
            return view('chat');
        })->name('chat');
        
    //  Route yang dapat diakses jika user sudah login dan Role = Administrator atau Admin Gudang
    Route::middleware('role:Administrator,Admin Gudang')->group(function () {
    ...
    //  Route yang dapat diakses jika user sudah login dan Role = Administrator
