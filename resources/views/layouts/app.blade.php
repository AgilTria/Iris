            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <nav class="pull-left">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="nav-link" href="https://www.instagram.com/user.equanimity._/profilecard/?igsh=eXlzMjVjZ3E3ZzYz">
                                    Agil Tria
                                </a>
                            </li>
                    ...
                    <div class="copyright ms-auto">
                        &copy; 2024 - <a href="https://www.instagram.com/user.equanimity._/profilecard/?igsh=eXlzMjVjZ3E3ZzYz" target="_blank" class="text-brand fw-semibold">Agil Tria Nugraha</a>.
                    </div>
                </div>
            </footer>
        </div>
