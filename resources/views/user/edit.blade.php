                    ...
                    <div class="col-lg-6">
                        ...
                        <div>
                            ...
                            <select name="role" class="form-select select2-single @error('role') is-invalid @enderror" autocomplete="off">
                                ...
                                <option {{ old('role', $user->role) == 'Administrator' ? 'selected' : '' }} value="Administrator">Administrator</option>
                                <option {{ old('role', $user->role) == 'Admin Gudang' ? 'selected' : '' }} value="Admin Gudang">Admin Gudang</option>
                                <option {{ old('role', $user->role) == 'Kepala Gudang' ? 'selected' : '' }} value="Kepala Gudang">Kepala Gudang</option>
                            </select>
